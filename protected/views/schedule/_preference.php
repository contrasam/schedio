        ...
        <table id="days-map">
            ...
            <tr>
                <td>
                    ...
                    <br/>from Time: <br/><?php echo $form->dropDownList($model, 'fromTimeM', $timeArray); ?>
                    <br/>to Time: <br/><?php echo $form->dropDownList($model, 'toTimeM', $timeArray); ?>
                </td>
                <td>
                    <?php echo $form->checkBox($model, 'dayT') ?>&nbsp;&nbsp;&nbsp;
                    <br/>from Time: <br/><?php echo $form->dropDownList($model, 'fromTimeT', $timeArray); ?>
                    <br/>to Time: <br/><?php echo $form->dropDownList($model, 'toTimeT', $timeArray); ?>
                </td>
                <td>
                    <?php echo $form->checkBox($model, 'dayW') ?>&nbsp;&nbsp;&nbsp;
                    <br/>from Time: <br/><?php echo $form->dropDownList($model, 'fromTimeW', $timeArray); ?>
                    <br/>to Time: <br/><?php echo $form->dropDownList($model, 'toTimeW', $timeArray); ?>
                </td>
                <td>
                    <?php echo $form->checkBox($model, 'dayR') ?>&nbsp;&nbsp;&nbsp;
                    <br/>from Time: <br/><?php echo $form->dropDownList($model, 'fromTimeR', $timeArray); ?>
                    <br/>to Time: <br/><?php echo $form->dropDownList($model, 'toTimeR', $timeArray); ?>
                </td>
                <td>
                    <?php echo $form->checkBox($model, 'dayF') ?>&nbsp;&nbsp;&nbsp;
                    <br/>from Time: <br/><?php echo $form->dropDownList($model, 'fromTimeF', $timeArray); ?>
                    <br/>to Time: <br/><?php echo $form->dropDownList($model, 'toTimeF', $timeArray); ?>
                </td>
                <td>
                    <?php echo $form->checkBox($model, 'dayS') ?>&nbsp;&nbsp;&nbsp;
                    <br/>from Time: <br/><?php echo $form->dropDownList($model, 'fromTimeS', $timeArray); ?>
                    <br/>to Time: <br/><?php echo $form->dropDownList($model, 'toTimeS', $timeArray); ?>
                </td>
                <td>
                    <?php echo $form->checkBox($model, 'dayU') ?>&nbsp;&nbsp;&nbsp;
                    <br/>from Time: <br/><?php echo $form->dropDownList($model, 'fromTimeU', $timeArray); ?>
                    <br/>to Time: <br/><?php echo $form->dropDownList($model, 'toTimeU', $timeArray); ?>
                </td>
            </tr>
            </tbody>
        </table>
